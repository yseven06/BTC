...
ASSETS = [
    {"symbol": "BTCUSDT",  "name": "Bitcoin / Tether",       "asset_type": AssetType.CRYPTO, "market": "binance"},
    {"symbol": "ETHUSDT",  "name": "Ethereum / Tether",      "asset_type": AssetType.CRYPTO, "market": "binance"},
    {"symbol": "THYAO.IS", "name": "Türk Hava Yolları A.Ş.", "asset_type": AssetType.STOCK,  "market": "bist"},
    {"symbol": "GARAN.IS", "name": "Garanti BBVA Bankası",   "asset_type": AssetType.STOCK,  "market": "bist"},
]
