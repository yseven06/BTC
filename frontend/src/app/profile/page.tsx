...
export default function ProfilePage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <GlassCard>
        <div className="flex items-center gap-4 mb-5">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-lg font-display text-text-primary truncate">{user.full_name ?? user.email.split('@')[0]}</h2>
            <p className="text-sm text-text-muted truncate flex items-center gap-1.5">
              <Mail className="w-3.5 h-3.5" /> {user.email}
            </p>
          </div>
          {user.is_admin && (
            <span className="flex items-center gap-1 px-3 py-1 rounded-lg bg-amber/15 border border-amber/30 text-amber text-xs font-display">
      ...
      {/* Update profile */}
      <GlassCard>
        <h3 className="text-sm font-display text-text-primary mb-4">Profil Bilgileri</h3>
        <div className="space-y-3">
          <div>
            <label className="text-xs font-display text-text-muted uppercase">Ad Soyad</label>
            <input
              type="text"
              value={fullName}
          ...
          <div>
            <label className="text-xs font-display text-text-muted uppercase">Profil Fotoğrafı</label>
          ...
          <div>
            <label className="text-xs font-display text-text-muted uppercase">E-posta</label>
            <input
              type="email"
              value={user.email}
              disabled
        ...
        <div className="flex items-center gap-3 mt-5">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-accent-primary text-white text-sm font-display hover:bg-accent-hover transition-colors disabled:opacity-50"
          >
      ...
      {/* Change password */}
      <GlassCard>
        <h3 className="text-sm font-display text-text-primary mb-4 flex items-center gap-2">
...
function PasswordField({
  ...
  return (
    <div>
      <label className="text-xs font-display text-text-muted uppercase">{label}</label>
